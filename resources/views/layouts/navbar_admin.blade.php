...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex h-screen bg-gray-200">
        <aside class="w-64 bg-gradient-to-b from-[#700207] to-[#4a0105] text-white flex-shrink-0 hidden md:block shadow-xl">
            {{-- Border diubah --}}
            <div class="p-5 text-2xl font-extrabold tracking-wide border-b border-[#700207]/50">
                🎂 DARA CAKE
            </div>
            <nav class="mt-4 space-y-1">
                {{-- Link aktif diubah --}}
                <a href="/dashboard-admin" class="flex items-center px-5 py-3 bg-[#4a0105] text-white rounded-lg">
                    <i class="fas fa-tachometer-alt w-6 text-center"></i>
                    <span class="mx-3 font-medium">Dashboard</span>
                </a>
                {{-- Link non-aktif diubah --}}
                <a href="/daftar-produk" class="flex items-center px-5 py-3 text-gray-200 hover:bg-[#700207] hover:text-white rounded-lg transition">
                    <i class="fas fa-box-open w-6 text-center"></i>
                    <span class="mx-3 font-medium">Produk</span>
                </a>
                <a href="/category" class="flex items-center px-5 py-3 text-gray-200 hover:bg-[#700207] hover:text-white rounded-lg transition">
                    <i class="fas fa-tags w-6 text-center"></i>
                    <span class="mx-3 font-medium">Kategori</span>
                </a>
                <a href="{{ route('admin.pesanan.index') }}" class="flex items-center px-5 py-3 text-gray-200 hover:bg-[#700207] hover:text-white rounded-lg transition">
                    <i class="fas fa-box w-6 text-center"></i>
                    <span class="mx-3 font-medium">Pesanan</span>
                </a>
                <a href="#" class="flex items-center px-5 py-3 text-gray-200 hover:bg-[#700207] hover:text-white rounded-lg transition">
            ...
            <header class="flex justify-between items-center px-6 py-4 bg-white shadow-md">
                ...
                <div x-data="{ dropdownOpen: false }" class="relative">
                    <button @click="dropdownOpen = !dropdownOpen"
                        ...
                        {{-- Border avatar diubah --}}
                        <img src="https://i.pravatar.cc/150?u=a042581f4e29026704d" alt="Admin"
                             class="w-10 h-10 rounded-full border-2 border-[#700207] shadow">
